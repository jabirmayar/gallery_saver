...
class GallerySaver {
  ...
  static Future<bool?> saveVideo(String path,String videoName, {String? albumName}) async {
    File? tempFile;
  ...
  static Future<bool?> saveImage(String path, String imageName, {String? albumName}) async {
    File? tempFile;
    if (path == null || path.isEmpty) {
      throw ArgumentError(pleaseProvidePath);
    }
